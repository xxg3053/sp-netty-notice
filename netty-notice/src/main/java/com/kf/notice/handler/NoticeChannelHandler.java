 ...
 * @Package com.kf.notice.handler
 * @Description: TODO
 * @date 2018/8/10 下午1:04
 */
public class NoticeChannelHandler extends SimpleChannelInboundHandler<Object> {


    private static final Logger LOGGER = LoggerFactory.getLogger(NoticeChannelHandler.class);
    ...
    private void doHandlerWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame msg) {
        ...
        //可以对消息进行处理
        //群发
        //NettyConfig.group.writeAndFlush(new TextWebSocketFrame(((TextWebSocketFrame) msg).text()));
        String text = ((TextWebSocketFrame) msg).text();
        System.out.println(text);
        NettyConfig.userChannel.put("1",ctx.channel());
    }
